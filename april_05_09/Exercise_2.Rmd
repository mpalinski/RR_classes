...
Season `r params$season` of Game of Thrones consisted of `r seasons[params$season, "eps"]` episodes. The show gathered an average of `r seasons[params$season, "views"]` first-day TV viewers in the US.
